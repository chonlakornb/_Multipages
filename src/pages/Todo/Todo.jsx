    ...
    return (
        <div className='todo-container'>
            ...
            <div className='todo-filters-container'>
                ...
                <select className="form-select" aria-label="Default select example" defaultValue={10} style={{ width: '200px' }} onChange={(e) => setItemsPerPage(e.target.value)}
                    ref={itemsPerPageRef}
                >
                                ...
                                return (
                                    <tr key={todo.id}>
                                        ...
                                        <td style={{ textAlign: 'right' }} valign='middle'>
                                            ...
                                            &nbsp;
                                            <button className='btn btn-danger' onClick={() => deleteClcik(todo.id)}>
